    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center ">
            <div class="header-action">
                <h1 class="page-title">Welcome, {{Auth::user()->firstname}}</h1>
        ...
        <div class="container-fluid">
            <div class="row clearfix row-deck">
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body ribbon">
                            ...
                            <a href="{{route('dashboard.profile', ['user'=>Auth::user()->id])}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('dashboard.course')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body ribbon">
                            ...
                            <a href="{{route('dashboard.transcript')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('dashboard.assignment')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('dashboard.attendance')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('dashboard.announcement')}}" class="my_sort_cut text-muted">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    <div class="font-14"><span>Recent exam record and performances. <a href="{{route('dashboard.transcript')}}">View All</a></span></div>
                                    <div>
                                        <a href="{{route('dashboard.transcript')}}" class="btn btn-primary">Transcript</a>
                                    </div>
                                </div>
                            </div>
                        </div>
