                ...
                <div class="card" style="min-height: 500px;">
                    ...
                    <form class="card-body">
                        {{-- <div class="form-group row">
                            <label class="col-md-3 col-form-label">User Type <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                                    ...
                                    <div class="card-body23">
                                        <div class="cardHead" style="display: inline-flex; justify-content: flex-start; width: 269.86px; margin: -3px 0 0 -4px; border-radius: 10px 10px 0 0; background: #8E0E00; background: -webkit-linear-gradient(to right, #1F1C18, #8E0E00); background: linear-gradient(to right, #1F1C18, #8E0E00);">
                                            <div class="schlogo" style="width: 80px; display: flex; justify-content: center; align-items: center; padding: 5px 0;">
                                                <img src="{{'../../../../public/backend/assets/images/user.png'}}" style="max-width: 70px; border-radius: 10px;" alt="" srcset="">
                                            </div>
                                        ...
                                        <div class="cardInner">
                                            <h3 style="font-weight: bold; padding: 3px 20px; border-radius: 10px; font-size: 7px; color: #000; text-align: center; margin-top: -14px;">Student matric: <span style="color: #17a2b8;">{{$fetch->regno}}</span></h3>
                                            <div class="cardHead" style="display: inline-flex; justify-content: flex-start; width: 100%;">
                                                <div class="schlogo" style="width: 70px;">
                                                    <img src="{{$fetch->student_img}}" style="min-width: 80px; min-height: 81px; position: relative; top: -8px; border-radius: 10px;" alt="" srcset="">
                                                </div>
                                                <div class="schinfo" style="padding: 7px 0 0 17px; line-height: 4px; display: flex; flex-direction: column;">
                                                    <div class="det">
                                                        ...
                                                        <p style="font-size: 8px; display: inline-block;">{{$fetch->firstname}}</p>
                                                    </div>
                                                    <div class="det">
                                                    ...
                                                    <div class="det">
                                                        ...
                                                        <p style="font-size: 8px; display: inline-block;">{{$fetch->studtype}}</p>
                                                    </div>
                                                    <div class="det">
                                                        <p style="font-size: 10px; display: inline-block;"><b>Gender: </b></p>
                                                        <p style="font-size: 8px; display: inline-block;">{{$fetch->gender}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
