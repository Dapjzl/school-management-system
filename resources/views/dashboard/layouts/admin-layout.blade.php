        ...
        <div class="container">
            <div class="hleft">
                ...
                <div class="dropdown">
                    ...
                    <a href="{{route('admin.dashboard')}}" class="nav-link icon"><i class="fe fe-search" data-toggle="tooltip" data-placement="right" title="Search..."></i></a>
                    <a href="{{route('admin.dashboard')}}"  class="nav-link icon app_inbox"><i class="fe fe-inbox" data-toggle="tooltip" data-placement="right" title="Inbox"></i></a>
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <div class="tab-content mt-3">
                ...
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li><a><i class="fa fa-user-circle"></i><span>Human Resources <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.employee')}}"><i class="fa fa-user-circle"></i><span>Employee</span></a></li>
                                <li><a href="{{route('dashboard.designation')}}"><i class="fa fa-user-circle"></i><span>Designation</span></a></li>
                                <li><a href="{{route('dashboard.leave')}}"><i class="fa fa-user-circle"></i><span>Leave</span></a></li>

                            </ul>
                        </li>
                        <li><a><i class="fa fa-user-circle"></i><span>Students <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.registered')}}"><i class="fa fa-user-circle"></i><span>Registered Students</span></a></li>
                                <li><a href="{{route('dashboard.prospective')}}"><i class="fa fa-user-circle"></i><span>Prospective Students</span></a></li>
                            </ul>
                        </li>
                        @endif
                        @if (Auth::user()->utype =="ADM")
                        <li><a><i class="fa fa-user-circle"></i><span>Generate ID Card <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.identitycard')}}"><i class="fa fa-user-circle"></i><span>Student ID Card</span></a></li>
                                {{-- <li><a href="{{route('dashboard.identitycard.lecturercard')}}"><i class="fa fa-user-circle"></i><span>Lecturer Card</span></a></li> --}}
                                {{-- <li><a href="{{route('dashboard.identitycard.employeecard')}}"><i class="fa fa-user-circle"></i><span>Employee Card</span></a></li> --}}
                            </ul>
                        </li>
                        @endif
                        <li><a><i class="fa fa-user-circle"></i><span>Exam <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.examattendance')}}"><i class="fa fa-user-circle"></i><span>Exam Attendance</span></a></li>
                                <li><a href="{{route('dashboard.exammark')}}"><i class="fa fa-user-circle"></i><span>Exam Mark</span></a></li>
                                <li><a href="{{route('dashboard.examschedule')}}"><i class="fa fa-user-circle"></i><span>Exam Schedule</span></a></li>
                                <li><a href="{{route('dashboard.examsuggestion')}}"><i class="fa fa-user-circle"></i><span>Exam Suggestion</span></a></li>
                            </ul>
                        </li>
                        <li><a><i class="fa fa-user-circle"></i><span>Announcement<i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.holiday')}}"><i class="fa fa-user-circle"></i><span>Holiday</span></a></li>
                                <li><a href="{{route('dashboard.news')}}"><i class="fa fa-user-circle"></i><span>News</span></a></li>
                                <li><a href="{{route('dashboard.notice')}}"><i class="fa fa-user-circle"></i><span>Notice</span></a></li>
                            </ul>
                        </li>
                        {{-- <li><a><i class="fa fa-user-circle"></i><span>Class <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.routine')}}"><i class="fa fa-user-circle"></i><span>Class Routine</span></a></li>
                            </ul>
                        </li> --}}

                        <li><a href="{{route('dashboard.section')}}"><i class="fa fa-bed"></i><span>Section</span></a></li>
                        <li><a href="{{route('dashboard.department')}}"><i class="fa fa-home"></i><span>Departments</span></a></li>
                        <li><a href="{{route('dashboard.course')}}"><i class="fa fa-graduation-cap"></i><span>Courses</span></a></li>
                        @if (Auth::user()->utype =="STD")
                        <li><a href="{{route('dashboard.transcript')}}"><i class="fa fa-file"></i><span>Transcript</span></a></li>
                        @endif
                        <li><a href="{{route('dashboard.syllabus')}}"><i class="fa fa-bed"></i><span>Syllabus</span></a></li>
                        <li><a href="{{route('dashboard.assignment')}}"><i class="fa fa-book"></i><span>Assignment</span></a></li>

                        <li><a><i class="fa fa-book"></i><span>Library <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.librarymembers')}}"><i class="fa fa-book"></i><span>Library Members</span></a></li>
                                <li><a href="{{route('dashboard.book')}}"><i class="fa fa-book"></i><span>Books</span></a></li>
                                <li><a href="{{route('dashboard.ebook')}}"><i class="fa fa-book"></i><span>E-Books</span></a></li>
                                <li><a href="{{route('dashboard.issue')}}"><i class="fa fa-book"></i><span>Issue And Return</span></a></li>
                                
                            </ul>
                        </li>
                         <li><a href="{{route('dashboard.hostel')}}"><i class="fa fa-bed"></i><span>Hostel</span></a></li>
                        <li><a href="{{route('dashboard.attendance')}}"><i class="fa fa-user-circle"></i><span>Attendance</span></a></li>
                        <li><a href="{{route('dashboard.certificate')}}"><i class="fa fa-folder"></i><span>Certificate</span></a></li>
                        <li><a href="{{route('dashboard.complain')}}"><i class="fa fa-map"></i><span>Complain</span></a></li>
            ...
            <div class="tab-pane fade" id="menu-admin" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        <li><a href="{{route('dashboard.accounting')}}"><i class="fa fa-bar-chart"></i><span>Accounting</span></a></li>
                        <li><a href="payments.html"><i class="fa fa-credit-card"></i><span>Payments</span></a></li>
                        <li><a href="{{route('dashboard.frontoffice')}}"><i class="fa fa-user-circle"></i><span>Front Office</span></a></li>
                        <li><a><i class="fa fa-pie-chart"></i><span>Report<i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.expenditure')}}"><i class="fa fa-user-circle"></i><span>Expenditure Report</span></a></li>
                                <li><a href="{{route('dashboard.activity')}}"><i class="fa fa-user-circle"></i><span>Activity Report</span></a></li>
                                <li><a href="{{route('dashboard.income')}}"><i class="fa fa-user-circle"></i><span>Income Report</span></a></li>
                                <li><a href="{{route('dashboard.duefee')}}"><i class="fa fa-user-circle"></i><span>Due Fee Report</span></a></li>
                                <li><a href="{{route('dashboard.duebalance')}}"><i class="fa fa-user-circle"></i><span>Due Balance Report</span></a></li>
                                <li><a href="{{route('dashboard.attendancereport')}}"><i class="fa fa-user-circle"></i><span>Attendance Report</span></a></li>
                                <li><a href="{{route('dashboard.examreport')}}"><i class="fa fa-user-circle"></i><span>Exam Report</span></a></li>
                                <li><a href="{{route('dashboard.libraryreport')}}"><i class="fa fa-user-circle"></i><span>Library Report</span></a></li>
                                <li><a href="{{route('dashboard.studentreport')}}"><i class="fa fa-user-circle"></i><span>Student Report</span></a></li>
                                <li><a href="{{route('dashboard.payroll')}}"><i class="fa fa-user-circle"></i><span>Payroll Report</span></a></li>
                                <li><a href="{{route('dashboard.lecturerreport')}}"><i class="fa fa-user-circle"></i><span>Lecturers Report</span></a></li>
                                <li><a href="{{route('dashboard.transactions')}}"><i class="fa fa-user-circle"></i><span>Transactions Report</span></a></li>
                            </ul>
                        </li>
                        <li><a><i class="fa fa-truck"></i><span>Transport <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="{{route('dashboard.transportroute')}}"><i class="fa fa-truck"></i><span>Transport Route</span></a></li>
                                <li><a href="{{route('dashboard.transportmember')}}"><i class="fa fa-truck"></i><span>Transport Member</span></a></li>
                                <li><a href="{{route('dashboard.transportvehicles')}}"><i class="fa fa-truck"></i><span>Transport Vehicles</span></a></li>
                            </ul>
                        </li>
                    ...
                    <div class="notification d-flex">
                        ...
                        <div class="dropdown d-flex">
                            <a href="javascript:void(0)" class="chip ml-3" data-toggle="dropdown">
                                <span class="avatar" style="background-image: url(../assets/images/xs/avatar5.jpg)"></span> {{Auth::user()->firstname}}</a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <a class="dropdown-item" href="{{route('dashboard.profile')}}"><i class="dropdown-icon fe fe-user"></i> Profile</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        Copyright © {{date('Y')}} <a href="">Hybridsoft LTD</a>.
                    </div>
