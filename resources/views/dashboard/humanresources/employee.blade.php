        ...
        <div class="tab-content">
                            ...
                            <table class="table table-hover text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="tag tag-green">{{$emp->emp_type}}</span></td>
                                        <td></td>
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="tab-pane active"  id="Fees-add">
                <div class="row clearfix">
                            <form action="{{ route('addStaff') }}"  enctype="multipart/form-data" id="apply_online" method="POST">
                                @csrf
                                <div class="row clearfix">
                                            ...
                                            <div class="card-body">
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        ...
                                                        @error('employee_type') <p class=" text-danger">{{ $message }}</p> @enderror
                                                    </div>
                                                </div>
                                                    <div class="card-header">
                                                    <h3 class="card-title">Academic Information</h3>
                                                          ...
                                                          <div class="row clearfix">
                                                            ...
                                                            <div class="col-md-6 col-sm-12">
                                                                ...
                                                                @error('salary_pay_grade') <p class=" text-danger">{{ $message }}</p> @enderror
                                                            </div>
                                                            <div class="col-md-6 col-sm-12">
                                                                <div class="form-group">
                                                                ...
                                                                @error('salary_type') <p class=" text-danger">{{ $message }}</p> @enderror
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                @error('resume') <p class=" text-danger">{{ $message }}</p> @enderror
                                                            </div>
                                                          </div>
