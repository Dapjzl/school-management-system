            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="box_style_1">
                        <form action="{{ route('updateStudent', ['regno'=>$regno]) }}"  enctype="multipart/form-data" id="apply_online" method="POST">
                            @csrf
                            ...
                            <div class="wrapper_indent">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @error('choice') <p class=" text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="col-md-6">
