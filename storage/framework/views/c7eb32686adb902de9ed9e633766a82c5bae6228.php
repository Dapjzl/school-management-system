    ...
    <div class="container-fluid">
        <div class="tab-content">
            ...
            <div class="tab-pane" id="Fees-add">
                <form action="<?php echo e(route('addAssignment')); ?>"  enctype="multipart/form-data" id="apply_online" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mt-2 mb-3">
                                            ...
                                            <input type="file" class="dropify" name="assignment">
...
<?php echo $__env->make('dashboard.layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/dashboard/assignment/index.blade.php ENDPATH**/ ?>