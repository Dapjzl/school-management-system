            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="box_style_1">
                        <form action="<?php echo e(route('updateStudent', ['regno'=>$regno])); ?>"  enctype="multipart/form-data" id="apply_online" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="styled-select">
                                            <select class="form-control required" name="choice" id="country_apply">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="styled-select">
                                            <select class="form-control required" name="choice2" id="country_apply">
                                                <option value="" selected>Select a Course</option>
                                                <option>English</option>
                                                <option>Mathematics</option>
                                                <option>Mechanical Engineering</option>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control styled required" id="address_apply"
                                                name="waec">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="wrapper_indent">
                                <p><button type="submit" class="button">Finish</button></p>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/continue.blade.php ENDPATH**/ ?>