...
<div class="sub_header bg_1">
    <div id="intro_txt">
        <h1>Atena <strong>Diploma</strong>courses</h1>
        <p>
...
<div class="container_gray_bg">
    <div class="container margin_60">
        <div class="row">
            <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="course_list_desc">
                                ...
                                <p>
                                    Zril causae ancillae sit ea. Dicam veritus mediocritatem sea ex, nec id agam eius. Te pri facete latine salutandi, scripta mediocrem et sed, cum ne mundi vulputate....
                                </p>
                                <ul class="add_info">
                                    <li>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <div class="details_list_col">
                                <div>
                                    <a href="academic_single_course.html" class="button_outline">Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="strip_all_courses_list wow fadeIn" data-wow-delay="0.1s">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="img_list">
                                <a href="academic_single_course.html"><img src="img/course_4.jpg" alt="">
                                <div class="short_info">
                                    <h3>Arts</h3>
                                </div>
                                </a>
                ...
                <div class="strip_all_courses_list wow fadeIn" data-wow-delay="0.1s">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="img_list">
                                <a href="academic_single_course.html"><img src="img/course_5.jpg" alt="">
                                <div class="short_info">
                                    <h3>Music</h3>
                                </div>
                                </a>
            ...
            <p>
                Zril causae ancillae sit ea. Dicam veritus mediocritatem sea ex, nec id agam eius. Te pri facete latine salutandi, scripta mediocrem et sed, cum.
            </p>
            <hr class="styled">
            <div class="box_side">
                <h5>By Phone</h5>
                ...
                <p>
                    <a href="tel://033284322">+ 0043 848293 43</a><br>
            ...
            <div class="box_side">
                ...
                <p>
                    ...
                    <br>
                    <em>4 West 31st Street New York<br>
                     10001 United States</em>
                </p>
            </div>
            <hr class="styled">
            <div class="box_side">
                ...
                <p>
                    <a href="apply_online.html" class="button small">Apply online</a>
                </p>
            </div>
            </aside>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/programme.blade.php ENDPATH**/ ?>