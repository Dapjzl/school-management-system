...
<div id="preloader">
    ...
    <div id="copy">
            <div class="container">
                 © College <?php echo e(date('Y')); ?> - All rights reserved.
            </div>
     </div><!-- End copy -->
...
<?php if(Session::has('error')): ?>
    <script>
        swal("Oops", "<?php echo Session::get('error'); ?>" ,"error" ,{
            button:"OK",
        });
    </script>
<?php endif; ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/layouts/front.blade.php ENDPATH**/ ?>