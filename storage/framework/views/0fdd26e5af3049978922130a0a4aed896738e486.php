                ...
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li><a><i class="fa fa-book"></i><span>Library <i class="fa fa-angle-right"></i></span></a>
                            <ul>
                                <li><a href="<?php echo e(route('dashboard.librarymembers')); ?>"><i class="fa fa-book"></i><span>Library Members</span></a></li>
                                <li><a href="<?php echo e(route('dashboard.book')); ?>"><i class="fa fa-book"></i><span>Books</span></a></li>
                                <li><a href="<?php echo e(route('dashboard.ebook')); ?>"><i class="fa fa-book"></i><span>E-Books</span></a></li>
                                <li><a href="<?php echo e(route('dashboard.issue')); ?>"><i class="fa fa-book"></i><span>Issue And Return</span></a></li>
...
<?php /**PATH C:\xampp\htdocs\school\resources\views/dashboard/layouts/admin-layout.blade.php ENDPATH**/ ?>