        ...
        <div class="container-fluid">
            <div class="row clearfix row-deck">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body ribbon">
                            ...
                            <a href="<?php echo e(route('dashboard.employee')); ?>" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="<?php echo e(route('dashboard.library')); ?>" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="<?php echo e(route('dashboard.holiday')); ?>" class="my_sort_cut text-muted">
...
<?php echo $__env->make('dashboard.layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/dashboard/index.blade.php ENDPATH**/ ?>