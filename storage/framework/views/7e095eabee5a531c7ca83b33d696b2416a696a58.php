        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="Fees-add">
                <div class="row clearfix">
                    <form action="<?php echo e(route('addDesignation')); ?>"  enctype="multipart/form-data" id="apply_online" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <?php $__errorArgs = ['designation_note'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <?php $__errorArgs = ['designation_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class=" text-danger"><?php echo e($message); ?></p> <?php unset($message);
...
<?php echo $__env->make('dashboard.layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/dashboard/humanresources/designation.blade.php ENDPATH**/ ?>