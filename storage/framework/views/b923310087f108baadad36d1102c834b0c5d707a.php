<?php $__env->startSection('title', 'College::Home'); ?>
<?php $__env->startSection('content'); ?>
<div id="full-slider-wrapper">
    <div id="layerslider" style="width:100%;height:650px;">
        <!-- first slide -->
        <div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
            <img src="front/img/slides/slide_1.jpg" class="ls-bg" alt="Slide background">
        	<h3 class="ls-l slide_typo" style="top: 45%; left: 50%;" data-ls="offsetxin:0;durationin:2000;delayin:1000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotatexout:90;transformoriginout:50% bottom 0;" >Atena <strong>Excellence</strong> in teaching</h3>
        ...
        <!-- second slide -->
    <div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
            <img  src="front/img/slides/slide_2.jpg" class="ls-bg" alt="Slide background">
     ...
     <!-- third slide -->
     <div class="ls-slide" data-ls="slidedelay:5000; transition2d:5;" >
             <img src="front/img/slides/slide_3.jpg" class="ls-bg" alt="Slide background">
    ...
    <!-- fourth slide -->
    <div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
        <img src="front/img/slides/slide_4.jpg" class="ls-bg" alt="Slide background">
    ...
    <div class="container_gray_bg" id="home_feat_1">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="home_feat_1_box">
                            <a href="#">
                            <img src="front/img/home_feat_1_1.jpg" class="img-responsive" alt="">
            ...
            <div class="home_feat_1_box">
                            <a href="#">
                            <img src="front/img/home_feat_1_2.jpg" class="img-responsive" alt="">
            ...
            <div class="home_feat_1_box">
                            <a href="#">
                            <img src="front/img/home_feat_1_3.jpg" class="img-responsive" alt="">
    ...
    <div class="container margin_60">
        ...
        <div class="row add_bottom_60">
            ...
            <div id="graph">
            <img src="front/img/graphic.jpg" class="wow zoomIn" data-wow-delay="0.1s" alt="">
                ...
                <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item active">
                            ...
                            <small><img class="img-circle" src="front/img/testimonial_1.jpg" alt="">Stefany</small>
                        </div>
                        <!-- Quote 2 -->
                        <div class="item">
                            <blockquote>
                                ...
                                <small><img class="img-circle" src="front/img/testimonial_2.jpg" alt="">Karla</small>
                        </div>
                        <!-- Quote 3 -->
                        <div class="item">
                            <blockquote>
                            ...
                            <small><img class="img-circle" src="front/img/testimonial_1.jpg" alt="">Maira</small>
                        </div>
                    </div>
                </div>
            </div>
				...
				<div class="content">
					<section id="section-1">
						<div class="row list_courses_tabs">
							...
							<ul>
                            	<li><div><a href="#"><figure><img src="front/img/course_1_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Mathemacis</strong> diploma</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_2_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Sciences</strong> diploma</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_3_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Litterature</strong> diploma</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_4_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Arts</strong> diploma</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_5_thumb.jpg" alt="" class="img-rounded"></figure>
							...
							<ul>
                            	<li>
                                <div><a href="#"><figure><img src="front/img/course_6_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Engineering</strong> graduate</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_7_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Biology</strong> graduate</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_8_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Psicology</strong> graduate</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_9_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Economy</strong> graduate</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_10_thumb.jpg" alt="" class="img-rounded"></figure>
							...
							<ul>
                            	<li><div><a href="#"><figure><img src="front/img/course_11_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Information tecnology</strong> master</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li><div><a href="#"><figure><img src="front/img/course_12_thumb.jpg" alt="" class="img-rounded"></figure>
                           	    <h3><strong>Digital media</strong> master</h3><small>Start 3 October 2015</small></a></div>
                                </li>
                                <li>
                                <div><a href="#"><figure><img src="front/img/course_13_thumb.jpg" alt="" class="img-rounded"></figure>
					...
					<section id="section-2">
						<div class="row list_news_tabs">
                        	<div class="col-md-4 col-sm-4">
                            <p><a href="#0"><img src="front/img/news_1_thumb.jpg" alt="" class="img-responsive"></a></p>
...
<h3><a href="#0">Success Stories for Atena College in 2015's </a></h3>
                            ...
                            <div class="col-md-4 col-sm-4">
                            <p><a href="#0"><img src="front/img/news_2_thumb.jpg" alt="" class="img-responsive"></a></p>
                                  <span class="date_published">20 Agusut 2015</span>
<h3><a href="#0">Boost in A-Level Grades in 2015 for Students</a></h3>
                            ...
                            <div class="col-md-4 col-sm-4">
                            <p><a href="#0"><img src="front/img/news_3_thumb.jpg" alt="" class="img-responsive"></a></p>
                                  <span class="date_published">20 Agusut 2015</span>
<h3><a href="#0">Caps Off To Sport at Atena</a></h3>
					...
					<div class="row list_news_tabs">
                        	<div class="col-md-4 col-sm-4">
                            <p><a href="#0"><img src="front/img/event_1_thumb.jpg" alt="" class="img-responsive"></a></p>
                                  <span class="date_published">20 Agusut 2015</span>
<h3><a href="#0">Next students meeting</a></h3>
                            ...
                            <div class="col-md-4 col-sm-4">
                            <p><a href="#0"><img src="front/img/event_2_thumb.jpg" alt="" class="img-responsive"></a></p>
                                  <span class="date_published">20 Agusut 2015</span>
<h3><a href="#0">10 October Open day</a></h3>
                            ...
                            <div class="col-md-4 col-sm-4">
                            <p><a href="#0"><img src="front/img/event_3_thumb.jpg" alt="" class="img-responsive"></a></p>
                                  <span class="date_published">20 Agusut 2015</span>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/index.blade.php ENDPATH**/ ?>