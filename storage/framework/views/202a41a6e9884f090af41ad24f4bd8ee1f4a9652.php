<?php $__env->startSection('title', 'Coninue Previous'); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="box_style_1">
                        <form action="<?php echo e(route('updateStudentAfter')); ?>"  enctype="multipart/form-data" id="apply_online" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/continueafter.blade.php ENDPATH**/ ?>