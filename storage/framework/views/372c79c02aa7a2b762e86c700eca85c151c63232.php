                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $pros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($key + 1); ?></td>
                                        <td><img src="<?php echo e($pro->student_img); ?>" alt="" style="height: 30px; width: 30px; border-radius: 50%;"></td>
                                        <td><?php echo e($pro->firstname.' '.$pro->lastname); ?></td>
                                        <td><?php echo e($pro->phone); ?></td>
                                        <td><?php echo e($pro->regno); ?></td>
                                        <td><?php echo e($pro->first_choice); ?></td>
                                        <td><?php echo e($pro->class); ?></td>
                                        <td><?php echo e($pro->studtype); ?></td>
                                        <td><span class="tag tag-green"><?php echo e($pro->status); ?></span></td>
                                    </tr>
...
<?php echo $__env->make('dashboard.layouts.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/dashboard/student/prospective.blade.php ENDPATH**/ ?>