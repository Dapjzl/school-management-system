                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->firstname); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Last name</label>
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->lastname); ?>">
                                        </div>
                                    </div>
                                </div><!-- End row -->
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->email); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Phone number</label>
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->phone); ?>">
                                        </div>
                                    </div>
                                </div><!-- End row -->
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->regno); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Gender</label><br>
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->gender); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Date of birth</label>
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->dob); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Address line</label>
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->address); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>State</label>
                                            <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->state); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Country</label>
                                        <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->lga); ?>">
                                    </div>
                            ...
                            <div class="wrapper_indent">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->first_choice); ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Second Choice</label>
                                        <input readonly type="text" class="form-control styled required" name="" id="" value="<?php echo e($std->second_choice); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    
                                    <div class="col-md-12">
                                        <img src="<?php echo e($std->student_img); ?>" alt="">
                                    </div>
                                </div><!-- End row -->
                            </div>

                            <div class="wrapper_indent">
                                <a href="<?php echo e(route('front')); ?>"><p><button type="button" class="button">Done</button></p></a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/school/resources/views/continuesummary.blade.php ENDPATH**/ ?>